...
export default async function handler(req, res) {
  ...
  try {
    ...
    const SECTOR_CONFIG = [
      ...
      { sector:'台股 交換器 / 網通設備',        driveIndex:'SOX', stockSymbols:['2345.TW','3596.TW','3380.TW'] },
      ...
      { sector:'台股 NOR Flash / 利基記憶體',  driveIndex:'SOX', stockSymbols:['2337.TW','2344.TW','8299.TWO'] },
      ...
      { sector:'台股 成熟製程代工',             driveIndex:'SOX', stockSymbols:['2303.TW','5347.TWO'] },
      ...
      { sector:'台股 高速傳輸 / 光纖模組',     driveIndex:'SOX', stockSymbols:['3664.TWO','3630.TWO'] },
      { sector:'台股 IP 授權 / 矽智財',        driveIndex:'SOX', stockSymbols:['6643.TWO','3661.TW','3051.TW'] },
      { sector:'台股 玻璃基板 / 先進封裝材料', driveIndex:'SOX', stockSymbols:['2383.TW','6213.TW','8046.TW'] },
